...
import top.easyblog.titan.nestor.feign.config.http.encoder.CamelToUnderscoreEncoder;
import top.easyblog.titan.nestor.feign.internal.FeignLogger;
import top.easyblog.titan.nestor.feign.internal.OkHttpClientFactory;
...
public class FeignConfig {
    ...
    public ErrorDecoder error() {
        return (method, response) -> {
            throw new BusinessException(NestorResultCode.REMOTE_INVOKE_FAIL, response.reason());
        };
    }
