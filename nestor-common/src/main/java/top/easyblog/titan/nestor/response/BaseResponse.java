...
public class BaseResponse<T> implements Serializable {
    ...
    public boolean isSuccess() {
        return NestorResultCode.SUCCESS.getCode().equalsIgnoreCase(this.code);
    }

    public static <T> BaseResponse<T> ok(T data) {
        return new BaseResponse<>(data, "ok", NestorResultCode.SUCCESS.getCode());
    }

    public static <T> BaseResponse<T> fail() {
        return new BaseResponse<>(null, "fail", NestorResultCode.INTERNAL_ERROR.getCode());
    }
